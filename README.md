# pagila-hw
[![](https://github.com/valenxie/pagila-hw/workflows/tests/badge.svg)](https://github.com/valenxie/pagila-hw/actions?query=workflow%3Atests)
...
1. Solve the each of the problems in the `sql` folder.
    ...
    1. The script `check_answers.sh` will perform these checks for you automatically using the `diff` command.
       ...
       ```
1. Upload a link to your forked github repo on sakai,make sure the badge is green.
